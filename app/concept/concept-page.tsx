...
function PublicDesignerRanking({lang}:{lang:Language}){
 ...
 return <section className="publicCredits publicCreditsPending" id="designers"><div className="creditsHead"><span className="kicker">{c.collaborators}</span><h2 className="publicBrandTitle"><img src="/what-100-people-title.webp" width="1200" height="800" alt="WHAT 100 PEOPLE DO TO A GAME"/></h2><p>{lang==="zh"?"共同创作者名单将在人员信息确认后统一录入。":"The collaborator list will be added after participant information is confirmed."}</p></div><div className="collaboratorPending" role="status"><span>01—100</span><b>{lang==="zh"?"待录入":"To be added"}</b></div></section>
}
