...
import { d1, isLead, participantId, sha256 } from "../_shared";

export async function GET(req: NextRequest) {
  if(await isLead(req))return NextResponse.json({participant:{id:"owner",display_code:"Hera",locale:"zh"},role:"lead"},{headers:{"cache-control":"private, no-store"}});
