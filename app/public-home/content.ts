...
const zh={
 ui:{
  language:"语言",project:"项目",about:"理念",process:"过程",stories:"故事",survey:"项目问卷",creator:"创作入口",
...
const en={
 ui:{
  language:"Language",project:"Projects",about:"Concept",process:"Process",stories:"Stories",survey:"Project surveys",creator:"Creator access",
